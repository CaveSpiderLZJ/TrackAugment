...
//        File motionFile = new File(BuildConfig.SAVE_PATH, getTmpFileName(mRecordId, RootListBean.FILE_TYPE.MOTION.ordinal()));
//        File lightFile = new File(BuildConfig.SAVE_PATH, getTmpFileName(mRecordId, RootListBean.FILE_TYPE.LIGHT.ordinal()));
//        if (!motionFile.exists()) {
//            NetworkUtils.downloadRecordFile(mContext, mTaskListId, mTaskId, mSubtaskId, mRecordId,
//                    RootListBean.FILE_TYPE.MOTION.ordinal(), new FileCallback() {
//                @Override
...
//        if (!lightFile.exists()) {
//            NetworkUtils.downloadRecordFile(mContext, mTaskListId, mTaskId, mSubtaskId, mRecordId,
//                    RootListBean.FILE_TYPE.LIGHT.ordinal(), new FileCallback() {
//                        @Override
//                        public void onSuccess(Response<File> response) {
//                            File file = response.body();
